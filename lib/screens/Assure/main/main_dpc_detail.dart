...
class MainScreenAssurePriseChargeDetail extends StatelessWidget {
  final int iddemandeprisecharge;
  // const MainScreenAssurePriseChargeDetail( {super.key, required this.iddemandeprisecharge});
  const MainScreenAssurePriseChargeDetail({Key? key , required this.iddemandeprisecharge}) : super(key: key );
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: AssureprisenechargepageDetail(iddemandeprisecharge: this.iddemandeprisecharge,),
            ),
          ],
        ),
      ),

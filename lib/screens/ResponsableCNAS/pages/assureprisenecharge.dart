...
class prisenechargepage extends StatefulWidget {
  const prisenechargepage({Key? key}) : super(key: key);

  @override
  _assurepage createState() => _assurepage();
}

class _assurepage extends State<prisenechargepage> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                "Détail de Demande  de prise en charge ",
                style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                ...
                Padding(
                  ...
                  child: Theme(
                    ...
                    child: CheckboxListTile(
                      title: Text(
                        'Choisir vous-meme la structure sanitaire :',
                        style: TextStyle(color: Colors.black),
                      ),
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [validerbutton, refuser_button, terminer_button],
            ),
          ],
        ),
      ),
